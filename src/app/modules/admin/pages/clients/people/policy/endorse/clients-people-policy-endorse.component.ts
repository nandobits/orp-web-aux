...
@Component({
  selector: 'app-clients-people-policy-endorse',
  templateUrl: './clients-people-policy-endorse.component.html',
  styleUrls: ['./clients-people-policy-endorse.component.scss']
})
export class ClientsPeoplePolicyEndorseComponent implements OnInit {
    ...
    public onSavePolicy(){
        ...
        this.policyService.endorsePolicy(this.quotationCostId, this.policy).then( (res: any) => {
            if(res.error){
                alert(res.message);
            }else{
